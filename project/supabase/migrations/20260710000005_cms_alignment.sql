...
INSERT INTO site_content (section, content_key, content_value) VALUES
  ...
  ('stories', 'featured_section_desc', '"See how organisations like yours are achieving remarkable results with Marmidon."'::jsonb),
  ...
  ('events', 'events_highlights_title', '"Why attend Marmidon events?"'::jsonb),
  ...
  ('products', 'cta_desc', '"Try any Marmidon product free for 14 days. No credit card required."'::jsonb),
  ('products', 'cta_button', '"Start Free Trial"'::jsonb),
  ('industries', 'cta_title', '"Don''t see your industry?"'::jsonb),
  ('industries', 'cta_desc', '"Marmidon adapts to any sector. Talk to our team for a custom solution."'::jsonb),
