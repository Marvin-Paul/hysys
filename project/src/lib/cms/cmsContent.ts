...
const LEGACY_HOMEPAGE_COPY =
  /HYSYS|Salesforce|Agentic AI|Dreamforce|Trailblazer|AppExchange|Gartner|Forrester|Agentforce|Magic Quadrant|DIY approach|greatest platform for change|Take the pledge/i;
